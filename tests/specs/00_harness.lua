...
assert_eq(config.ui.connector_width, 9, "Connector core should default to a fixed nine-column width")
assert_eq(config.ui.connector_max_width, 9, "Connector core should not expand past the fixed default by default")
